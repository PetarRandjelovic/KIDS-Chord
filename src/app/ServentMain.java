...
public class ServentMain {
	...
	public static void main(String[] args) {
		...
		PingPongThread pingPongThread = new PingPongThread();
		Thread pingPongThreadInstance = new Thread(pingPongThread);
		pingPongThreadInstance.start();

		CLIParser cliParser = new CLIParser(simpleListener, pingPongThread);
