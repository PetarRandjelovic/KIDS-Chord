...
public class WelcomeHandler implements MessageHandler {
	...
	public void run() {
		if (clientMessage.getMessageType() == MessageType.WELCOME) {
			...
			UpdateMessage um = new UpdateMessage(AppConfig.myServentInfo.getListenerPort(), AppConfig.chordState.getNextNodePort(), "", AppConfig.myServentInfo.getListenerPort());
